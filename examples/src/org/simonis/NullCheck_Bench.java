...
public class NullCheck_Bench {
    ...
    public static class Param {
        final NullCheck_Bench n1 = new NullCheck_Bench();
        final NullCheck_Bench n2 = new NullCheck_Bench();
        final NullCheck_Bench n3 = new NullCheck_Bench();
        final NullCheck_Bench n4 = new NullCheck_Bench();
        final NullCheck_Bench nx = null;
    }
    ...
    @BenchmarkMode(Mode.AverageTime)
    @OutputTimeUnit(TimeUnit.NANOSECONDS)
    public static long getNullField_1(Param p) {
        try {
            return p.nx.l0001;
        }
    ...
    @BenchmarkMode(Mode.AverageTime)
    @OutputTimeUnit(TimeUnit.NANOSECONDS)
    public static long getNullField_2(Param p) {
        try {
            return p.nx.l0512;
        }
        catch(NullPointerException npe) {
    ...
    */
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(NullCheck_Bench.class.getSimpleName())
                .warmupIterations(5)
