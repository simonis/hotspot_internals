...
if [ "$1" == "safepoint" ]; then
export _JAVA_OPTIONS='-Xbatch -XX:+UseSerialGC -XX:-UseOnStackReplacement -XX:-TieredCompilation -XX:CICompilerCount=1 -XX:LoopUnrollLimit=0 -Djava.library.path=../cpp/ -XX:CompileCommand="quiet" -XX:-LogVMOutput'
else
